  ...
  "inline-flex items-center gap-1 rounded-md border px-2 py-0.5 text-[11px] font-medium tracking-wide transition-colors",
  {
    variants: {
      variant: {
        ...
        critical: "border-transparent bg-critical/15 text-critical ring-1 ring-inset ring-critical/30",
        ...
        signal: "border-transparent bg-signal/15 text-signal ring-1 ring-inset ring-signal/30",
